                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        ...
                        <h1>Covid Care Centers</h1>
                            <p>Currently, there are 4 government laboratories and 2 private laboratories approved to test Real-Time (RT) PCR tests; 1 government laboratory to test CBNAAT tests; 26 government laboratories to test TrueNat tests for COVID-19 in Jharkhand.
                            </p>
      ...
      <div class="container  text-center">
        ...
        <div class="row col-lg-12">
          ...
          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/jharkhand/">Isolation Centers</a></h4>
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/jharkhand/">Quarantine Centers</a></h4>
          </div>
    ...
    <!-- Start Align Area -->
     ...
     <div class="whole-wrap">
        <div class="container box_1170">
            <div class="col-lg-12">
                     <h2 class="title-1 m-b-25" id="iso" >Covid19 Health Care Centers In Jharkhand</h2>
   ...
   <script type="text/javascript">
    ...
    success : function(covid_data) {
     ...
     var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Jharkhand';
